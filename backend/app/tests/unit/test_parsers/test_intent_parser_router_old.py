...
class TestIntentParserRouter:
    ...
    def test_router_initialization(self, router):
        ...
        assert len(router.parsers) == 7  # All 7 parsers (including ADD_ITEM, REMOVE_ITEM, MODIFY_ITEM)
        ...
        assert IntentType.ADD_ITEM in router.parsers
        assert IntentType.REMOVE_ITEM in router.parsers
        assert IntentType.MODIFY_ITEM in router.parsers
    
    @pytest.mark.asyncio
    async def test_parse_intent_clear_order(self, router):
    ...
    @pytest.mark.asyncio
    async def test_parse_intent_confirm_order(self, router):
